import 'package:weather_app/features/auths/presentation/auth_route.dart';
import 'package:weather_app/features/auths/presentation/bloc/auth_bloc.dart';
import 'package:weather_app/features/auths/presentation/views/login_page.dart';
import 'package:weather_app/features/auths/presentation/views/register_page.dart';
import 'package:weather_app/features/home/presentation/bloc/home_bloc.dart';
import 'package:weather_app/features/home/presentation/home_route.dart';
import 'package:weather_app/features/home/presentation/views/home_page.dart';
import 'package:weather_app/features/movie_detail/presentation/bloc/movie_detail_bloc.dart';
import 'package:weather_app/features/movie_detail/presentation/movie_detail_route.dart';
import 'package:weather_app/features/movie_detail/presentation/views/movie_detail_screen.dart';
import 'package:weather_app/features/profile/domain/usecase/profile_usecase.impl.dart';
import 'package:weather_app/features/profile/presentation/bloc/profile_bloc.dart';
import 'package:weather_app/features/profile/presentation/profile_route.dart';
